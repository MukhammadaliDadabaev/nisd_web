...
Route::group(['prefix' => 'admin', 'middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'menus'], function () {
        ...
        Route::post('/', [MenuController::class, 'store'])->name('admin.menus.store');
        Route::get('/{menus}', [MenuController::class, 'show'])->name('admin.menus.show');
        Route::get('/{menus}/edit', [MenuController::class, 'edit'])->name('admins.menus.edit');
        Route::patch('/{menus}', [MenuController::class, 'update'])->name('admin.menus.update');
        Route::delete('/{menus}', [MenuController::class, 'destroy'])->name('admin.menus.destroy');
    });
